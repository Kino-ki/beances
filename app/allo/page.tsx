...
export default function AlloPage() {
  ...
  return (
    <div className="flex flex-col justify-end relative ">
      <div className="lg:bg-auto bg-contain bg-no-repeat bg-allobg lg:-mt-20  mr-8 lg:mr-20 h-[90vh]  bg-center">
        {isLoading && (
      ...
      {alloData && (
        <div className="flex flex-col justify-start h-full md:text-lg ">
          <div className="flex justify-center -mt- md:-mt-20  w-full md:mb-20 z-10">
            <Image
              src={triangle}
              width={60}
              height={10}
          ...
          <div className="md:shadow-[1px_-5px_40px_3px_rgba(0,0,0,0.06)] py-12 md:py-20 z-10 ">
          {title && (
          <div className=" flex flex-row lg:justify-start lg:mx-[5%]  lg:text-[5.5rem] text-6xl lg:pb-10"> 
          <h1 className="font-burnout tracking-widest md:tracking-[0.2em] lg:w-auto text-center w-full md:my-0 text-gblue">
            {title}
          </h1>
          </div>
        )}
